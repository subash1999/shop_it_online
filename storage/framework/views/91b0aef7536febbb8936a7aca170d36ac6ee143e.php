<div class="col-lg-9">
	...
	<div class="shop_content">
		<div class="shop_bar clearfix">
			<div class="shop_product_count"><span><?php echo e(count($results)); ?></span> products found</div>
		...
		<div class="product_grid">
			...
			<div class="product_item <?php echo e($result['is_new']? 'is_new':''); ?>">
				...
				<div class="product_content">
					...
					<div class="product_name"><div><a href="<?php echo e(url('product/'.$result['sp_id'])); ?>" tabindex="0"><?php echo e($result['name']); ?></a></div></div>
				</div>
