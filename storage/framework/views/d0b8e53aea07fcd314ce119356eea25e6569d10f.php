<html>
<head>
 <link rel="stylesheet" type="text/css" href="<?php echo e(asset('one_tech/styles/bootstrap4/bootstrap.min.css')); ?>">
 ...
 <link src="<?php echo e(asset('css/app.css')); ?>">
 <script src="<?php echo e(asset('one_tech/styles/bootstrap4/popper.js')); ?>"></script>
 <script src="<?php echo e(asset('one_tech/styles/bootstrap4/bootstrap.min.js')); ?>"></script>
 <link href="<?php echo e(asset('one_tech/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css')); ?>" rel="stylesheet" type="text/css">
 <?php echo $__env->make('layouts/favicon', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
 <title><?php echo e(config('app.name')); ?> : Customer Register</title>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>">
        ...
        <div class="card person-card">
            <div class="card-body">
                ...
                src="<?php echo e(asset('img/system/male.svg')); ?>">
                ...
                <div class="row">
                    <div class="form-group col-md-2">
                        ...
                        ?>
                        <select id="gender" name="gender" class="form-control <?php echo e($errors->has('gender') ? ' is-invalid' : ''); ?>" value="<?php echo e($old_gender ? old('gender') : 'Male'); ?>">
                    ...
                    <div class="form-group col-md-5">
                        <input id="first_name" name="first_name" type="text" class="form-control <?php echo e($errors->has('first_name') ? ' is-invalid' : ''); ?>" placeholder="First name" maxlength="100" value="<?php echo e(old('first_name')); ?>">
                    ...
                    <div class="form-group col-md-5">
                        <input id="last_name" name="last_name" type="text" class="form-control <?php echo e($errors->has('last_name') ? ' is-invalid' : ''); ?>" placeholder="Last name" maxlength="100" value="<?php echo e(old('last_name')); ?>">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control <?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" id="email" name="email" placeholder="example@gmail.com" required maxlength="100" value="<?php echo e(old('email')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>" id="phone" name="phone" maxlength="30" placeholder="+977 1234567890" required value="<?php echo e(old('phone')); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="country" id="country" class="form-control <?php echo e($errors->has('country') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('country')); ?>">
                                ...
                                <script>
                                    jQuery(document).ready(function($) {
                                        $country = "<?php echo e(old('country',null)); ?>";
                                        if($country!=null){
                                            $('#country').val($country);
                                        }
                                    });
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" class="form-control <?php echo e($errors->has('city') ? ' is-invalid' : ''); ?>" id="city" name="city" placeholder="Yout city/village"  maxlength="300" value="<?php echo e(old('city')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?php echo e($errors->has('address') ? ' is-invalid' : ''); ?>" id="address" name="address" placeholder="Your address"  maxlength="300" value="<?php echo e(old('address')); ?>">
                ...
                <div class="card"> 
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="username" name="username" class="form-control  <?php echo e($errors->has('username') ? ' is-invalid' : ''); ?>" id="username" placeholder="Type your Username" required value="<?php echo e(old('username')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control  <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" id="password" name="password" placeholder="Type your password" required>
...
<script>
    // URLs images
    var female_img = "<?php echo e(asset('img/system/female.png')); ?>";
    var male_img = "<?php echo e(asset('img/system/male.svg')); ?>";
