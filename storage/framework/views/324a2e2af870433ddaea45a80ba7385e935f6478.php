...
<form id="regForm" action="<?php echo e(asset('seller/register/step2')); ?>" enctype="multipart/form-data" method="post">
	...
	<div class="tab">
		...
		<?php echo $__env->make('seller/seller_register/seller_register_pages/seller_information_form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	</div>
	<div class="tab">
		...
		<?php echo $__env->make('seller/seller_register/seller_register_pages/company_information_form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	</div>
	<div class="tab">
		...
		<?php echo $__env->make('seller/seller_register/seller_register_pages/contact_information_form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	</div>
	<div class="tab">
		...
		<?php echo $__env->make('seller/seller_register/seller_register_pages/information_verification_form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	</div>
...
<?php echo $__env->make('seller/seller_register/seller_register_pages/js_seller_register_step_2', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('seller/seller_register/seller_register_layout/seller_register_layout', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>