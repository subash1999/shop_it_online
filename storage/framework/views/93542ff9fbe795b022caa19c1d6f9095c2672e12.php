...
<div class="form-group">
	...
	<img id="your_cover_view" name="your_cover_view" class="img-thumbnail form-control rounded" src="<?php echo e(asset('img/system/upload_cover_pic.png')); ?>" alt="profile picture placeholder"  class="img-fluid rounded-circle m-3" style="cursor: pointer; height: 300px;" required="required" width="100%" >
...
<div class="form-group">
	...
	<img id="your_certificate_view" name="your_certificate_view" class="img-thumbnail form-control rounded" src="<?php echo e(asset('img/system/upload_cover_pic.png')); ?>" alt="profile picture placeholder"  class="img-fluid rounded-circle m-3" style="cursor: pointer; height: 200px; width: 80%;" required="required"  >
	<div class="btn upload_btn" style="cursor: pointer;">
