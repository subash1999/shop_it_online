...
$(document).ready(function(){
  ...
  $('#fax').val("<?php echo e(old('fax')); ?>");
  var fax_country = "<?php echo e(old('fax_country')); ?>";
  if(fax_country!=""){
  ...
  var country = "<?php echo e(old('country')); ?>";
  if(country!=null){
    $('#country').val();
    var country_code = $('#country').val();    
    $("#country_verify").text($('option[value='+country_code+']').text());    
...
var old_user = "<?php echo e(old('user')); ?>";
var user = "<?php echo e($user); ?>";
if(user!=""){

  user = $.parseJSON(<?php echo(json_encode($user)) ?>);
