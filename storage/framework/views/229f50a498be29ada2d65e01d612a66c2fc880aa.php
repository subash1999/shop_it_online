		...
		<div class="row">
			...
			<div class="col-lg-3 footer_col">
				<div class="footer_column footer_contact">
					<div class="logo_container">
						<div class="logo"><a href="#"><?php echo e(config('app.name')); ?></a></div>
					</div>
			...
			<div class="col-lg-2 offset-lg-2">
				<div class="footer_column">
					...
					<ul class="footer_list">
						...
						<li><a href="<?php echo e(route('register')); ?>">Customer Register</a></li>
			...
			<div class="col-lg-2">
				<div class="footer_column">
					...
					<ul class="footer_list">
						<li><a href="<?php echo e(url('customer')); ?>">My Account</a></li>
