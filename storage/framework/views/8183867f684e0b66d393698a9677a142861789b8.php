						...
						<div class="header_search_content">
							<div class="header_search_form_container">
								<form action="<?php echo e(url('all_products')); ?>" method="get" class="header_search_form clearfix">
									<input type="search" required="required" id="keyword" name="keyword" class="header_search_input" placeholder="Search for products...">
				...
				<div class="col">
					...
					<div class="page_menu_content">
						...
						<div class="menu_contact">
							<div class="menu_contact_item"><div class="menu_contact_icon"><img src="<?php echo e(asset('one_tech/images/phone_white.png')); ?>" alt=""></div>+38 068 005 3570</div>
							<div class="menu_contact_item"><div class="menu_contact_icon"><img src="<?php echo e(asset('one_tech/images/mail_white.png')); ?>" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
						</div>
					</div>
				</div>
			</div>
