<div>
	...
	<tbody>
		...
		$input_id_num =1;
		?>
		<tr name="feature[<?php echo e($input_id_num); ?>]" id="tr_feature_<?php echo e($input_id_num); ?>">
			<td>				
				<input type="text" name="feature[<?php echo e($input_id_num); ?>][name]" id="feature<?php echo e($input_id_num); ?>" class="form-control" autocomplete="off">
			</td>
			<td>				
				<input type="text" name="feature[<?php echo e($input_id_num); ?>][value]" id="feature<?php echo e($input_id_num); ?>_value" class="form-control" autocomplete="off">
			</td>
			<td>
				<span  class="btn btn-round btn-danger" onclick="delete_feature_row(<?php echo e($input_id_num); ?>)" id="delete_feature_row" name="delete_feature_row">Delete Feature</span>
			</td>
		</tr>
	</tbody>
</table>
...
<?php $__env->startSection('formwise_asset'); ?>
<script>
	/*Script for the the feature increment*/
	// Script to add the feature list
	var count = <?php echo e(++$input_id_num); ?>;
