	...
	<div class="form-group">
			...
			<div class="form-row">
				<div class="m-2 form-row float-right">	
					<figure style="width: 70%; margin-left: 20px; max-width: 200px;">			
						<img src="<?php echo e(asset('img/system/user_photo_placeholder.jpg')); ?>" alt="User's Photo" class="img-thumbnail" id="user_photo_verify" name="user_photo_verify">
						<figcaption>User Photo</figcaption>
					</figure>
				</div>
				<div class="form-inline m-2">	
					<figure style="width: 70%;margin-left: 20px;">
						<img src="<?php echo e(asset('img/system/upload_id.png')); ?>" alt="User's Identity Proof" class="img-thumbnail" id="user_identity_verify" name="user_identity_verify">
		...
		<div class="">
			<div class="form-inline m-2" >
				...
				<u><label class="form-control-label" id="name_verify" name="name_verify"><?php echo e(old('name_verify')); ?></label></u>
			</div>
			<div class="form-inline m-2">	
	...
	<div class="form-group">
		...
		<div class="form-row form-group">
			<div class="form-group m-2" >
				...
				<figure style="width: 70%; margin-left: 20px;">
					<img src="<?php echo e(asset('img/system/upload_photo.png')); ?>" alt="Company Cover Photo" class="img-thumbnail" id="company_cover_verify" name="company_cover_verify">
		...
		<div class="form-row form-group">
			<div class="form-group m-2" >
				...
				<figure style="width: 70%;margin-left: 20px;">
					<img src="<?php echo e(asset('img/system/upload_photo.png')); ?>" alt="Company Certificate Proof" class="img-thumbnail" id="company_certificate_verify" name="company_certificate_verify" >
