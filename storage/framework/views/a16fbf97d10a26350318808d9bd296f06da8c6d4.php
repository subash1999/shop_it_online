<?php $__env->startSection('center-content'); ?>
    <?php echo $__env->make('admin.sb_admin.admin_pages.admin_dashboard.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
