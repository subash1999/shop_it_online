...
<div class="" style="margin: 10px; padding: 10px; width:100%">
	<div class="">
		...
		<div class="alert alert-success d-none" id="product_add">
		...
		@endif --}} 
		{{-- For printing the server error form the form_submit ajax error --}}
	...
	<div class="card-body">		
		...
		<form id="product_add_form" method="post" style="width:100%;" enctype="multipart/form-data">	
			...
			<div >
				{{-- Style for the nav-item so that there will be pointer when hovering over --}}
				<style type="text/css">
				a.nav-item.nav-link {
					cursor: pointer;
				}
			...
			<div class="tab-content" id="nav-tabContent">
				<div class="tab-pane fade in active" id="category">
					@include('seller/seller_dashboard/seller_dashboard_pages/seller_dashboard_product/new_product_category_tab')
				</div>
				<div class="tab-pane fade " id="product">
					@include('seller/seller_dashboard/seller_dashboard_pages/seller_dashboard_product/new_product_product_tab')
				</div>
				<div class="tab-pane fade" id="options">
					@include('seller/seller_dashboard/seller_dashboard_pages/seller_dashboard_product/new_product_options_tab')
				</div>
				<div class="tab-pane fade " id="features">
					@include('seller/seller_dashboard/seller_dashboard_pages/seller_dashboard_product/new_product_features_tab')
				</div>	
				<div class="tab-pane fade " id="keywords">
					@include('seller/seller_dashboard/seller_dashboard_pages/seller_dashboard_product/new_product_keywords_tab')
				</div>					
			</div>
		</div>
		<hr>
		<div align="middle">
			{{-- <input type="reset" class="btn btn-danger " value="Reset Product From"> --}}
...
{{-- Links for the form of the adding new product --}}
<link rel="stylesheet" type="text/css" href="{{ asset('page_assets/seller/dashio/lib/bootstrap-fileupload/bootstrap-fileupload.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('page_assets/seller/dashio/lib/bootstrap-datepicker/css/datepicker.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('page_assets/seller/dashio/lib/bootstrap-daterangepicker/daterangepicker.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ asset('page_assets/seller/dashio/lib/bootstrap-timepicker/compiled/timepicker.css') }}" />
...
<script src="{{ asset('page_assets/seller/dashio/lib/jquery-ui-1.9.2.custom.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('page_assets/seller/dashio/lib/bootstrap-fileupload/bootstrap-fileupload.js') }}"></script>
<script type="text/javascript" src="{{ asset('page_assets/seller/dashio/lib/bootstrap-datepicker/js/bootstrap-datepicker.js') }}"></script>
<script type="text/javascript" src="{{ asset('page_assets/seller/dashio/lib/bootstrap-daterangepicker/date.js') }}"></script>
<script type="text/javascript" src="{{ asset('page_assets/seller/dashio/lib/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script type="text/javascript" src="{{ asset('page_assets/seller/dashio/lib/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js') }}"></script>
<script type="text/javascript" src="{{ asset('page_assets/seller/dashio/lib/bootstrap-daterangepicker/moment.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('page_assets/seller/dashio/lib/bootstrap-timepicker/js/bootstrap-timepicker.js') }}"></script>

<script src="{{ asset('page_assets/seller/dashio/lib/advanced-form-components.js') }}"></script>
<link rel="stylesheet" type="text/css" href="{{ asset('api/shieldui/css/light-bootstrap/all.min.css') }}">
{{-- shield UI --}}
{{-- jszip or shield ui --}}
{{-- <script src="{{ asset('api/shieldui/js/jszip.min.js') }}"></script> --}}
<script src="{{ asset('api/shieldui/js/shieldui-all.min.js') }}"></script>
{{-- Script for the tree view in category display --}}
<script type="text/javascript">
	$(".tree_view").shieldTreeView();
	
</script>
{{-- Check if the required fields are filled while changing the tabs --}}
...
{{-- Script for the save and finish button to stop submission if there is not required fields filled --}}
<script>	
	$(document).ready(function() {
		...
		function form_submit(this_form) {
			...
			$.ajax({
				url: '{{ url('seller/dashboard/new_product_store') }}',
				type: 'post',
				dataType: "json",
				processData: false,
				contentType : false,
			...
			.done(function(data) {
    			...
    			$.each(data.success,function() {
    				...
    				bootbox.alert({
    					...
    					<a href="{{ url('product/')}}/${data.sp_id}">New Product Link</a>`,
    				});	
...
{{-- Bootbox js bootbox.js if for bootstrap 3 and 4 while bootbox.min.js is for only bootstrap 3  --}}
{{-- there is a error if we use bootbox.min.js for bootstrap 4 in close button misplacement --}}
<script src="{{ asset('api/bootbox/bootbox.js') }}"></script>
@endsection