...
<div class="form-group">
	...
	<div class="form-inline">
		<input id="first_name" type="text" maxlength="100" class="form-control" name="first_name"  autocomplete="name"  style="margin-right:15px; margin-top: 5px;" placeholder="First Name..." value="{{old('first_name')}}">
...
<div class="row">
	<div class="  form-inline">
		...
		<img id="your_photo_view" class="img-thumbnail" src="{{ asset('img/system/user_photo_placeholder.jpg') }}" alt="profile picture placeholder" width="100px" height="100px" class="img-fluid rounded-circle m-3" style="cursor: pointer;" required="required" name="your_photo_view" >		
	...
	<div class="  form-inline">
		...
		<img id="your_id_view" class="img-thumbnail" src="{{ asset('img/system/upload_id.png') }}" alt="profile picture placeholder" width="100px" height="100px" class="img-fluid rounded-circle m-3" style="cursor: pointer;" required="required" name="your_id_view">
		<div class="btn upload_btn" style="cursor: pointer;">
