...
<img id="" class="img-thumbnail upload_preview_image" src="{{ asset('img/system/user_photo_placeholder.jpg') }}" alt="profile picture placeholder" width="100px" height="100px" class="img-fluid rounded-circle m-3" style="cursor: pointer;" required="required">		
