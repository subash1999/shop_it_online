...
#loader {
  ...
  opacity: 0.7;
  background-image: url({{ asset('img/system/website_logo_2.png') }});
...
<div style="width: 100%;">
  <div id="overlay"  onload="checkOverlap()">
    <div style="z-index:1;" id="loading-text" >
     ...
     <h3 class="h3 text-center text-secondary">Loading <img src="{{ asset('img/system/webpage_loading.gif') }}" alt=""></h3>              
   </div>      
