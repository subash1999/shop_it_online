						...
						<div class="panel-body">
							...
							<div class="col-lg-6" align="center">
								...
								<div class="col-sm-8" >
									...
									<img id="photo" src="{{ asset('img/system/upload_photo_icon.png') }}" style="width: 2;height: 150px;" alt="your Image" />
								</div>
								<hr>
							</div>	
							...
							<div class="col-lg-6" align="left">
								...
								<div class="col-sm-8">
									...
									<img id="id" src="{{ asset('img/system/upload_photo_icon.png') }}" style="width: 150px;height: 150px;" alt="your ID" />
								</div>
								<hr>
							</div>	
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="panel-body">
						...
						<div class="form-group row">
							<div class="col-lg-6">
								{{-- <input type="reset" style="margin: 10px;" name="reset" value="RESET Form" class="btn-lg btn-warning"> --}}
							</div>
							<div class="col-lg-6">
...
<!-- Script for the page -->
<script src="{{ asset('api/password_strength_api/pwstrength-bootstrap.min.js') }}"></script>
<script src="{{ asset('page_assets/admin/users/add_admin/admin_users_add_admin.js') }}"></script>
