...
<div id="page-wrapper">
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            ...
            <div class="panel-heading">
              List of Different Types of Users in {{config('app.name')}}
            </div>
 ...
 <script>
  window.get_user_types_table_url = "{{ URL::to('admin/users/user_types/get_table') }}"; 
</script>
<!-- Script written in the blade.php for the writing of php in js code -->
@include('admin/sb_admin/admin_pages/admin_users/js_admin_users_user_types')
<!-- Script for the custom datatable for user_type -->
{{-- <script src="{{ asset('page_assets/admin/users/user_types/user_types_datatable.js') }}"></script> --}}


{{-- javascript for the user_types under user --}}
{{-- <script src="{{ asset('page_assets/admin/users/user_types/admin_users_user_types.js') }}"></script> --}}
<script >
